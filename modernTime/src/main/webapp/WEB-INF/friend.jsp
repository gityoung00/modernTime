...
<meta property="og:url" content="https://kw.everytime.kr/friend">
...
<link type="text/css" href="/css/container.friend.css" rel="stylesheet">
...
<script type="text/javascript" src="/js/friend.index.js"></script>
<script type="text/javascript" src="/js/friend.accept.js"></script>
<script type="text/javascript" src="/js/friend.find.js"></script>
</head>
<body>
	...
	<nav>
		<div class="wrap">
			...
			<ul id="menu">
				...
				<li class="active"><a href="/friend">친구</a></li>
	...
	<div id="container" class="friend">
		...
		<form id="friendRequest" class="search">
			<input type="text" name="userid" placeholder="아이디 혹은 이메일 검색으로 친구 요청"
				autocomplete="off">
		</form>
		<div class="friendrequestlist"></div>
