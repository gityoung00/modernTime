...
<body style="">
	...
	<div id="container" class="article">
		<input type="hidden" id="isUser" value="1"> <input type="hidden" id="boardId" value="${post.id }"> <input type="hidden" id="commentId"
			value="${comment.id }"> <input type="hidden" id="postTitle" value="${post.title }"> <input type="hidden" id="postContent"
			value="${post.content }">
		<aside class="none">
			<div class="title">
				<a class="hamburger"></a>
