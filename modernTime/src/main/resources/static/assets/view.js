...
//      var $groupStatusImages = $('.images').appendTo($groupStatus);
//      var $groupStatusImagesWrap = $('.wrap').width(images.length * 130).appendTo($groupStatusImages);
//      var images = _.compact(_.flatten([data.cover_image, data.images]));
//      _.each(images, function (image) {
//        $('.image').css('background-image', 'url("' + image + '")').appendTo($groupStatusImagesWrap);
//      });
