...
<html lang="ko"><head>
  ...
  <meta property="og:url" content="https://kw.everytime.kr/register">
  <meta property="og:site_name" content="광운대 모던타임">
  <meta property="og:title" content="광운대 모던타임">
  ...
  <meta name="keywords" content="모던타임, 에타, everytime, 시간표, 수강신청, 강의평가, 학점계산기, 학식, 오늘의학식, 책방, 중고책, 대학생, 대학교, 대학, 대학생 시간표, 대학교 시간표, 대학생 커뮤니티, 대학교 커뮤니티, 시간표 앱, 시간표 어플">
  ...
  <script type="text/javascript" src="/js/forgot/forgot.pw.form.js"></script>
...
<form id="container" method="post" action="/register/form">
    <h2>회원가입</h2>
    <p class="description">모던타임 계정으로 <strong>모던타임</strong>의<br>다양한 대학생 서비스를 모두 이용하실 수 있습니다.</p>
    <input type="hidden" name="id" value="${id }" class="pass">
    <div class="input">
    <div class="label"><label>새 비밀번호 입력</label></div>
    <input type="password" name="pw" class="pass">
    </div>
    <div class="input">
