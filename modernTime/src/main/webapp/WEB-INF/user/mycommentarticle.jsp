...
<head> 
  ...
  <script type="text/javascript" src="/js/post/board.mycommentindex.js"></script>
...
<div id="submenu">
	...
	<div id="container" class="article">
		<input type="hidden" id="isUser" value="1"> <input
			type="hidden" id="boardId" value="mycommentarticle">
		<aside class="none">
			<div class="title">
				<a class="hamburger"></a>
				<h1>
					<a href="/mycommentarticle">댓글 단 글</a>
				</h1>
			</div>
		</aside>
		...
		<div class="wrap articles">
			<!-- <article>
				<a class="article" href="/389161/v/264168725">
				<img src="https://cf-fpi.everytime.kr/0.png" class="picture medium">
				<h3 class="medium">익명</h3>
					<time class="medium">08/19 21:41</time>
					<hr>
					<h2 class="medium bold">진짜 너무 화난다</h2>
					<p class="medium">
						전에 아빠가 거래처한테 인계 받을게 있어서<br>
						<br>몇시에 어디서 보기로 약속잡고 갔는데<br>
						<br>연락도 안되다가 약속시간 한참 오바해서 여직원이 왔대<br>
						<br>근데 뭐 늦어서 미안하단 기색도 없고 해서<br>
						<br>아빠가 시간 약속은 지켜달라고 했는데<br>
						<br>(아빠 성격이 순하고 남 듣기 싫은 말 못해서<br>최대한 기분 안나쁘게 했을거임)<br>
						<br>근데 본인이 쪽팔린걸 아는건지 적반하장으로<br>
						<br>나오더래 자기 기분 나빴다고 그러다 어찌저찌 마무리 됐는데<br>
						<br>어제 아빠
					</p>
					<span class="more">... 더 보기</span><a href="/389161"
					class="boardname">자유게시판</a>
				<ul class="status">
					...
					<hr>
					<input type="hidden" name="264168725_comment_anonym" value="0"></a>
				<div class="comments"></div>
			</article> -->
			<!-- <div class="clearBothOnly"></div>
			<div class="pagination">
				<a href="/mycommentarticle/p/2" class="next">다음</a>
			</div> -->
		</div>
		<hr>
		<div class="rightside">
			<div class="card">
				<div class="board">
					...
					<a class="list" href="/434318/v/264901266"><time>08/25
							14:03</time>
						<p>어디서 뭔 빙신같은 바퀴벌레가 기어들어와서 물 흐리냐</p>
						<hr></a><a class="list" href="/389161/v/264882561"><time>08/25
							11:37</time>
						<p>헤헤 맛있다</p>
						<hr></a><a class="list" href="/434318/v/264644331"><time>08/23
							17:08</time>
						<p>4) 실습나가서 눈치보는거 ㅈㄴ 힘들다..</p>
						<hr></a><a class="list" href="/389161/v/264110373"><time>08/19
							13:51</time>
						<p>올해 교양 교과목</p>
						<hr></a>
				</div>
